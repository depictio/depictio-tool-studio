const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pyodide-CeHwhMqd.js","assets/index-DC0Qx4s-.js","assets/index-DZVQ7BdV.css"])))=>i.map(i=>d[i]);
import{_ as c}from"./index-DC0Qx4s-.js";let r=null;async function d(){return r||(r=(async()=>{const t=await c(()=>import("./pyodide-CeHwhMqd.js"),__vite__mapDeps([0,1,2])),s=await t.loadPyodide({indexURL:`https://cdn.jsdelivr.net/pyodide/v${t.version}/full/`});return await s.loadPackage(["pandas","numpy","micropip"]),await s.pyimport("micropip").install("plotly"),s})().catch(t=>{throw r=null,t})),r}const l=`
import warnings
